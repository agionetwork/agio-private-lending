...
const t: Record<Lang, {
  ...
  en: {
    ...
    foreclosureTrigger: "Foreclosure trigger: ratio falls below 120%",
    ...
    foreclosureRiskDesc: "If your collateral ratio drops below 120%, the lender can foreclose and seize your collateral irreversibly. Monitor your ratio and add collateral proactively during volatile markets.",
  },
  es: {
    ...
    foreclosureTrigger: "Activación de ejecución: el ratio cae por debajo del 120%",
    ...
    foreclosureRiskDesc: "Si tu ratio de garantía cae por debajo del 120%, el prestamista puede ejecutar y confiscar tu garantía irreversiblemente. Monitorea tu ratio y añade garantía proactivamente durante mercados volátiles.",
  },
  pt: {
    ...
    foreclosureTrigger: "Gatilho de execução: a taxa cai abaixo de 120%",
    ...
    foreclosureRiskDesc: "Se sua taxa de garantia cair abaixo de 120%, o credor pode executar e confiscar sua garantia irreversivelmente. Monitore sua taxa e adicione garantia proativamente durante mercados voláteis.",
  },
  zh: {
    title: "借入",
    ...
    foreclosureTrigger: "清算触发：比率降至 120% 以下",
    ...
    foreclosureRiskDesc: "如果您的抵押率降至 120% 以下，出借方可以清算并不可逆地没收您的抵押品。请监控您的比率，在市场波动期间主动追加抵押品。",
  },
}
